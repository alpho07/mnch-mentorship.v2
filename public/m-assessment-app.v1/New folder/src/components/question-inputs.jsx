                            ...
                            {opts.map((opt) => {
                                    ...
                                    return (
                                            <button key={opt} onClick={() => onChange(opt)} style={{
                                                        ...
                                                        border: `2px solid ${active ? "#6366F1" : T.border}`,
                                                        background: active ? "linear-gradient(135deg,#EEF2FF,#E0E7FF)" : T.borderLight,
                                                        color: active ? "#3730A3" : T.textMid,
                                                        fontWeight: active ? 700 : 400, fontSize: 13,
                                                        cursor: "pointer", textAlign: "left",
                                                        display: "flex", alignItems: "center", gap: 10,
                                                        transition: "all 0.15s",
                                                        boxShadow: active ? "0 2px 10px rgba(99,102,241,0.2)" : "none",
                                                            }}>
                                                <div style={{
                                                            width: 16, height: 16, borderRadius: "50%",
                                                            border: active ? "5px solid #6366F1" : `2px solid ${T.border}`,
