...
class FacilityTypeChart extends Component
{
    ...
    {
        $this->chartData = $this->analyticsService->getFacilityTypeDistribution($this->filters);
    }

    public function render()
    {
        return view('filament.livewire.charts.facility-type-chart');
    }
}