...
class StockRequestRejected extends Notification implements ShouldQueue
{
    ...
    {
        return \App\Support\NotificationEvents::STOCK_REQUEST_REJECTED;
    }
    ...
    {
        return "Request #{$this->stockRequest->request_number} was rejected: ".Str::limit($this->rejectionReason, 100);
    }
