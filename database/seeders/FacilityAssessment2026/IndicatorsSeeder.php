...
class IndicatorsSeeder extends Seeder
{
    ...
    private const PAEDIATRIC = [
        ...
        ['IND_PAED_SEVERE_PNEUMONIA_ADMISSIONS', 'Total Number of children under 5 years admitted with severe pneumonia', 0],
        ['IND_PAED_SEVERE_PNEUMONIA_OXYGEN', 'Total Number of children under 5 years with severe pneumonia initiated on oxygen', 0],
        ['IND_PAED_OXYGEN_CORRECT_PRESCRIPTION', 'Of these, how many had correct oxygen prescription (appropriate delivery device, flow rate and target SpO2)?', 1],
        ...
        ['IND_PAED_PNEUMONIA_ADMISSIONS', 'Total Number of children under 5 years admitted with pneumonia', 0],
        ...
        ['IND_PAED_DIARRHOEA_ADMISSIONS', 'Total Number of children under 5 years diagnosed with diarrhoea', 0],
        ...
        ['IND_PAED_OUTPATIENT_ATTENDANCE', 'Total Number of children under 5 years attending out-patient department', 0],
        ...
        ['IND_PAED_T1DM_ACTIVE', 'Total Number of children aged 0 to 18 years who have an active diagnosis of Type 1 Diabetes Mellitus', 0],
